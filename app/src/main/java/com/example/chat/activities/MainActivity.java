...
import com.example.chat.adapters.RecentConversionsAdapter;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners() {
        binding.imageSignOut.setOnClickListener(event -> signOut());
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnFailureListener(event -> showToast("unable to update token"));
    }
    ...
    private void signOut() {
        ...
        documentReference.update(updates)
                .addOnSuccessListener(unused -> {
                    ...
                    finish();
                }).addOnFailureListener(event -> showToast("unable to sign out"));
    }
